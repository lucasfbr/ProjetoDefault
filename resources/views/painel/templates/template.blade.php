...
<head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="/assets/painel/css/bootstrap.min.css">
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="/assets/painel/dist/css/AdminLTE.min.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="/assets/painel/dist/css/skins/_all-skins.min.css">
    <!-- iCheck -->
    <link rel="stylesheet" href="/assets/painel/plugins/iCheck/flat/blue.css">
    <!-- Morris chart -->
