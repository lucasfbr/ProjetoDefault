        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Edite um novo registro</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="col-md-10 col-md-offset-1">
                <form role="form" method="post" action="/painel/quemsomos/update/{{$quemsomos->id}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">

                        <div class="form-group{{ $errors->has('titulo_sobre') ? ' has-error' : '' }}">
                            <label for="titulo_sobre">Titulo Sobre a empresa</label>
                            <input class="form-control" id="titulo_sobre" name="titulo_sobre" type="text" value="{{ $quemsomos->titulo_sobre }}"
                                   autofocus>
                        ...
                        <div class="form-group{{ $errors->has('texto_sobre') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" id="texto_sobre" name="texto_sobre" cols="10" rows="5">{{ $quemsomos->texto_sobre }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('titulo_missao') ? ' has-error' : '' }}">
                            ...
                            <input class="form-control" id="titulo_missao" name="titulo_missao" type="text" value="{{ $quemsomos->titulo_missao }}"
                                   autofocus>
                        ...
                        <div class="form-group{{ $errors->has('texto_missao') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" id="texto_missao" name="texto_missao" cols="10" rows="5">{{ $quemsomos->texto_missao }}</textarea>
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" id="status" name="status" value="1" {{ $quemsomos->status == '1' ? 'checked' : '' }}><strong>Exibir na página principal</strong>
                            </label>
                        </div>
