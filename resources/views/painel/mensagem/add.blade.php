...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a href="/painel/mensagem" class="btn btn-primary btn-block margin-bottom">Caixa de entrada</a>
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Crie uma nova mensagem</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                      ...
                      &lt;p&gt;Thank you,&lt;/p&gt;
                      &lt;p&gt;John Doe&lt;/p&gt;
                    </textarea><iframe class="wysihtml5-sandbox" security="restricted" allowtransparency="true" marginwidth="0" marginheight="0" style="display: block; background-color: rgb(255, 255, 255); border-collapse: separate; border-color: rgb(210, 214, 222); border-style: solid; border-width: 1px; clear: none; float: none; margin: 0px; outline: 0px none rgb(85, 85, 85); outline-offset: 0px; padding: 6px 12px; position: static; top: auto; left: auto; right: auto; bottom: auto; z-index: auto; vertical-align: text-bottom; text-align: start; box-sizing: border-box; box-shadow: none; border-radius: 0px; width: 100%; height: 300px;" width="0" frameborder="0" height="0"></iframe>
                        </div>
                        <div class="form-group">
